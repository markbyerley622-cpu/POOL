...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-neon-blue/20 bg-background/90 backdrop-blur-md">
      <div className="flex items-center justify-between px-4 sm:px-8 py-3">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          >
            <Image
              ...
              width={36}
              height={36}
              className="rounded-full shadow-neon-blue sm:w-[44px] sm:h-[44px]"
            />
          </motion.div>
          <div>
            <h1 className="text-base sm:text-xl font-bold bg-gradient-to-r from-neon-blue via-electric-cyan to-neon-purple bg-clip-text text-transparent">
              POOL Wheel
            </h1>
            <p className="text-[9px] sm:text-[10px] text-electric-cyan/50 font-mono tracking-wider uppercase">
              Liquidity Flywheel
            </p>
          </div>
        </div>
        ...
        <motion.div
          className="hidden lg:flex justify-center flex-1 mx-4"
